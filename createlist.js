function CreateList() {
	...
	this.copyright = document.createElement("div"); //// this is not useful/////
	this.initialize.apply(this, arguments); ///////////////////////once object create , initialize will be invoke /////
...
CreateList.prototype = {
	initialize: function(aData) {		
		...
		this.copyright.innerHTML = "\u539f\u751fJavaScript\u5b66\u4e60, QQ:21314130, By &mdash; Ferris ¨ÊICP?10209901?";
		document.body.appendChild(this.oWrap); ////////////////////////////////////////////the template read to the website //////////////////////
